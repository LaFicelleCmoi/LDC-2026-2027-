...
(function (global) {
  ...
  var DICT = {
    ...
    'nav.palmares':    { fr: 'Palmarès',         en: 'Honours' },
    'pal.pageTitle':   { fr: 'Palmarès de la Ligue des Champions', en: 'Champions League honours' },
    'pal.pageSub':     { fr: 'Classement des clubs par nombre de titres (Coupe d’Europe / Ligue des Champions)', en: 'Clubs ranked by number of titles (European Cup / Champions League)' },
    'pal.colRank':     { fr: 'Rang',             en: 'Rank' },
    'pal.colClub':     { fr: 'Club',             en: 'Club' },
    'pal.colTitles':   { fr: 'Titres',           en: 'Titles' },
    'pal.colYears':    { fr: 'Années',           en: 'Years' },
    'pal.total':       { fr: 'clubs vainqueurs',  en: 'winning clubs' },
    ...
    'res.w':               { fr: 'Victoire', en: 'Win' },
    'res.d':               { fr: 'Match nul', en: 'Draw' },
    'res.l':               { fr: 'Défaite', en: 'Loss' },
    'res.wShort':          { fr: 'V', en: 'W' },
    'res.dShort':          { fr: 'N', en: 'D' },
    'res.lShort':          { fr: 'D', en: 'L' },
    'tnav.yesterday':      { fr: 'Hier', en: 'Yesterday' },
    'tnav.today':          { fr: "Aujourd'hui", en: 'Today' },
    'tnav.upcoming':       { fr: 'À venir', en: 'Upcoming' },
    'tnav.seeUpcoming':    { fr: 'Voir les prochains matchs', en: 'See upcoming matches' },
    'tnav.nextDate':       { fr: 'Prochaine date :', en: 'Next date:' },
    'wg.scorers':          { fr: 'Top buteurs', en: 'Top scorers' },
    'wg.assists':          { fr: 'Meilleurs passeurs', en: 'Top assists' },
    'wg.cleansheets':      { fr: 'Murailles', en: 'Clean sheets' },
    'wg.empty':            { fr: 'Pas encore de données.', en: 'No data yet.' },
    'zbar.search':         { fr: 'Rechercher un club…', en: 'Search a club…' },
    'zbar.allPots':        { fr: 'Tous', en: 'All' },
    'zbar.allCountries':   { fr: 'Tous les pays', en: 'All countries' },
    'sim.reset':           { fr: 'Réinitialiser', en: 'Reset' },
    'sim.clear':           { fr: 'Effacer ce score', en: 'Clear this score' },
    ...
    'dash.liveYesterday':  { fr: 'HIER',                 en: 'YESTERDAY' },
    'dash.liveUpcoming':   { fr: 'À VENIR',              en: 'UPCOMING' },
    'dash.liveMatchday':   { fr: 'JOURNÉE',              en: 'MATCHDAY' },
    ...
    'dash.rankingTitle':   { fr: '🏆 Classement de la saison', en: '🏆 Season ranking' },
    'dash.rankingAll':     { fr: 'Classement (phase de poules)', en: 'Ranking (group stage)' },
    ...
    'dash.emptyToday':     { fr: 'Aucun match prévu aujourd’hui.', en: 'No match scheduled today.' },
    'dash.emptyYesterday': { fr: 'Aucun match hier.', en: 'No match yesterday.' },
    'dash.emptyUpcoming':  { fr: 'Aucun match à venir cette saison.', en: 'No upcoming match this season.' },
    ...
    'trk.groupSub':        { fr: 'Phase de poules — classement combiné', en: 'Group stage — combined ranking' },
    ...
    /* ---- Prédicteur de classement (phase de ligue) ---- */
    'trk.pred.toggle':     { fr: '🔮 Mode prédiction',   en: '🔮 Prediction mode' },
    'trk.pred.exit':       { fr: '✓ Classement réel',    en: '✓ Real standings' },
    'trk.pred.reset':      { fr: 'Réinitialiser',        en: 'Reset' },
    'trk.pred.badge':      { fr: 'PRÉDICTION',           en: 'PREDICTION' },
    'trk.pred.title':      { fr: 'Pronostique les matchs — le classement et les zones se recalculent en direct.', en: 'Predict the matches — standings and zones recalculate live.' },
    'trk.pred.empty':      { fr: 'Aucun match à pronostiquer pour le moment.', en: 'No match to predict yet.' },
    'trk.pred.replay':     { fr: 'Saison terminée — rejoue toute la phase de ligue à ta façon.', en: 'Season over — replay the whole league phase your way.' },
    'trk.pred.count':      { fr: '{done}/{total} matchs pronostiqués', en: '{done}/{total} matches predicted' },
    /* ---- Parcours vers la finale (bracket interactif) ---- */
    'trk.viewRun':         { fr: '🏆 Mon parcours',       en: '🏆 My run' },
    'trk.run.title':       { fr: 'Construis ton parcours vers la finale', en: 'Build your run to the final' },
    'trk.run.hypo':        { fr: 'Appariements hypothétiques (tirage non officiel)', en: 'Hypothetical matchups (unofficial draw)' },
    'trk.run.random':      { fr: '🎲 Tirage aléatoire',   en: '🎲 Randomize' },
    'trk.run.reset':       { fr: 'Réinitialiser',         en: 'Reset' },
    'trk.run.share':       { fr: '🔗 Copier le lien',     en: '🔗 Copy link' },
    'trk.run.copied':      { fr: 'Lien copié !',          en: 'Link copied!' },
    'trk.run.champion':    { fr: 'Ton champion',          en: 'Your champion' },
    'trk.run.pick':        { fr: 'Clique le vainqueur de chaque confrontation.', en: 'Click the winner of each tie.' },
    'trk.run.empty':       { fr: 'Choisir',               en: 'Pick' },
    'trk.run.noData':      { fr: 'Aucune équipe disponible pour le moment.', en: 'No teams available yet.' },
    'trk.col.pos':         { fr: '#',                    en: '#' },
    ...
    'trk.round.qualif':    { fr: 'Qualifications',       en: 'Qualifying' },
    'trk.round.league':    { fr: 'Phase de poules',      en: 'Group / league stage' },
    ...
    'foot.tagline':        { fr: 'Format ligue unique, 36 équipes engagées, huit journées avant le couperet. Tout le parcours, un seul endroit.', en: 'One single league, 36 teams, eight matchdays before the cut. The whole campaign in one place.' },
    'foot.navLabel':       { fr: 'Plan du site', en: 'Site map' },
    'foot.competition':    { fr: 'Compétition', en: 'Competition' },
    'foot.stats':          { fr: 'Statistiques', en: 'Statistics' },
    'foot.more':           { fr: 'Et aussi', en: 'More' },
    'foot.simulator':      { fr: 'Simulateur What-If', en: 'What-If simulator' },
    'foot.fullSchedule':   { fr: 'Calendrier complet', en: 'Full schedule' },
    'foot.draw':           { fr: 'Tirage de la phase de ligue', en: 'League phase draw' },
    'foot.scorers':        { fr: 'Buteurs, passeurs, murailles', en: 'Scorers, assists, clean sheets' },
    'foot.knockout':       { fr: 'Phase finale', en: 'Knockout stage' },
    'foot.nextMatch':      { fr: 'Prochain match', en: 'Next match' },
    'foot.kickoff':        { fr: 'Coup d’envoi', en: 'Kick-off' },
    'foot.matchday':       { fr: 'Journée', en: 'Matchday' },
    'foot.imminent':       { fr: 'Imminent', en: 'Imminent' },
    'foot.watchLive':      { fr: 'Suivre le direct', en: 'Watch live' },
    'foot.seasonOver':     { fr: 'Saison terminée', en: 'Season over' },
    'foot.see':            { fr: 'Voir', en: 'See' },
    'foot.notAffiliated':  { fr: 'Non affilié à l’UEFA', en: 'Not affiliated with UEFA' },
